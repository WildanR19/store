 ...
 * @property int|null $regencies_id
 ...
 * @property string $roles ADMIN & USER
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|User whereRegenciesId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|User whereRememberToken($value)
 * @method static \Illuminate\Database\Eloquent\Builder|User whereRoles($value)
 * @method static \Illuminate\Database\Eloquent\Builder|User whereStoreName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|User whereStoreStatus($value)
